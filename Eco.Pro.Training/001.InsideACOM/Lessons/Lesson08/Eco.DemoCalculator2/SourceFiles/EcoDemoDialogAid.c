...
static int32_t engine_handle_input(struct android_app* app, AInputEvent* event) {
    ...
    if (AInputEvent_getType(event) == AINPUT_EVENT_TYPE_MOTION) {
        ...
        if ( AMotionEvent_getAction(event) == AMOTION_EVENT_ACTION_DOWN) {
            ...
            LOGI("touch click up: x=%d y=%d", engine->state.x, engine->state.y);
                ...
                LOGI("equal: ");
                 ...
                 if (op == ADDITION_OPERATOR) {
                      LOGI("add: %d + %d", a, b);
					         LOGI("g_pIX: %p", g_pIX);
					         LOGI("g_pIY: %p", g_pIY);
                     c = app->m_pIX->pVTbl->Addition(app->m_pIX, a, b);
                      LOGI("add: %d + %d = %d", a, b, c);
                 }
                     ...
                     c = g_pIX->pVTbl->Subtraction(g_pIX, a, b);
                       ...
                       LOGI("mul: %d + %d", a, b);
					         LOGI("g_pIX: %p", g_pIX);
					         LOGI("g_pIY: %p", g_pIY);
							 c = app->m_pIY->pVTbl->Multiplication(app->m_pIY, a, b);
							                      LOGI("mul: %d + %d = %d", a, b, c); 
                 }
