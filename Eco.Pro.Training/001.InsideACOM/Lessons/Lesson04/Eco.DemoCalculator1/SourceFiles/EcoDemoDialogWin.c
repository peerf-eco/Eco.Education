...
int16_t DialogProcessing() {
    ...
    wndClass.lpszClassName = TEXT("Demo Calculator 1");
    ...
    InitCommonControls();
    hDlg = CreateWindow(TEXT("Demo Calculator 1"), TEXT("Demo Calculator 1"), WS_DLGFRAME | WS_POPUP | WS_CAPTION | WS_SYSMENU, x, y, 195, 260, NULL, NULL,  GetModuleHandle(0), NULL);
